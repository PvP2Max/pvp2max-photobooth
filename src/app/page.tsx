      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-10 md:py-16">
        ...
        <section className="space-y-4 rounded-3xl bg-white/5 p-6 ring-1 ring-white/10">
          <div className="flex items-center justify-between gap-2">
            ...
            <span className="rounded-full bg-pink-400/10 px-3 py-1 text-xs font-semibold text-pink-100">
              Step 3
            </span>
          </div>
        ...
        <section className="grid gap-4 rounded-3xl bg-white/5 p-6 ring-1 ring-white/10 md:grid-cols-[1.5fr,1fr]">
          <div className="space-y-3">
            <h3 className="text-lg font-semibold text-white">Delivery</h3>
            <p className="text-sm text-slate-300/80">
              We send the composed images to the client and immediately purge
              originals, cutouts, and background composites from disk to keep
              the booth lean.
            </p>
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-pink-400 to-cyan-300 px-4 py-3 text-sm font-semibold text-slate-950 transition hover:from-pink-300 hover:to-cyan-200 disabled:opacity-50"
            >
              {sending ? "Sending..." : "Send set & clean up storage"}
            </button>
            <p className="text-xs text-slate-300/70">
              Attachments are generated in-browser for speed; the server emails
              them via SMTP if configured, or saves them into the storage/outbox
              folder for manual handoff during local testing.
            </p>
          </div>
        </section>
      </main>
